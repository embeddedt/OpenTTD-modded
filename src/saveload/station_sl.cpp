...
static const SaveLoad _station_desc[] = {
	...
	SLE_CONDVAR_X(Station, airport.num_circle,        SLE_UINT8,   SL_MIN_VERSION, SL_MAX_VERSION, SlXvFeatureTest(XSLFTO_AND, XSLFI_HUGE_AIRPORTS)),
	      SLE_VAR(Station, airport.flags,              SLE_UINT64),
	SLE_CONDNULL_X(8, SL_MIN_VERSION, SL_MAX_VERSION, SlXvFeatureTest(XSLFTO_AND, XSLFI_SPRINGPP, 1, 6)),
	SLE_CONDVAR_X(Station, airport.flags2,             SLE_UINT64,                SL_MIN_VERSION, SL_MAX_VERSION, SlXvFeatureTest(XSLFTO_AND, XSLFI_HUGE_AIRPORTS)),
