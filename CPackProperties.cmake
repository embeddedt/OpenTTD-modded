...
set(CPACK_PACKAGE_VERSION "20210612-stock_jgr-g700016f440")

# Name the output file with the correct version
string(REPLACE "#CPACK_PACKAGE_VERSION#" "20210612-stock_jgr-g700016f440" CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}")
...
if (CPACK_BUNDLE_PLIST_SOURCE)
    ...
    string(REPLACE "#CPACK_PACKAGE_VERSION#" "20210612-stock_jgr-g700016f440" INFO_PLIST_CONTENT "${INFO_PLIST_CONTENT}")
