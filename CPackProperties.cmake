...
set(CPACK_PACKAGE_VERSION "20221023-stock_jgr-gda5403cabc")

# Name the output file with the correct version
string(REPLACE "#CPACK_PACKAGE_VERSION#" "20221023-stock_jgr-gda5403cabc" CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}")
...
if (CPACK_BUNDLE_PLIST_SOURCE)
    ...
    string(REPLACE "#CPACK_PACKAGE_VERSION#" "20221023-stock_jgr-gda5403cabc" INFO_PLIST_CONTENT "${INFO_PLIST_CONTENT}")
