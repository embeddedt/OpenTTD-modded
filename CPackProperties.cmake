...
set(CPACK_PACKAGE_VERSION "20210705-stock_jgr-g42c77a002d")

# Name the output file with the correct version
string(REPLACE "#CPACK_PACKAGE_VERSION#" "20210705-stock_jgr-g42c77a002d" CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}")
...
if (CPACK_BUNDLE_PLIST_SOURCE)
    ...
    string(REPLACE "#CPACK_PACKAGE_VERSION#" "20210705-stock_jgr-g42c77a002d" INFO_PLIST_CONTENT "${INFO_PLIST_CONTENT}")
